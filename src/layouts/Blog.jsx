  ...
  return (
    <section className='py-25'>
      <Container>
        ...
        <Title text="Our Latest Blog" className="text-center py-5"/>
        ...
        <Grid className="md:grid-cols-3 gap-7.5 mt-13">

          <div className='w-[85%] sm:w-100 md:w-full mx-auto rounded-[20px] overflow-hidden shadow-xl'>
